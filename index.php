    ...
    <div class="row">
      ...
      while ($room_data = mysqli_fetch_assoc($room_res)) {
        ...
        while ($fea_row = mysqli_fetch_assoc($fea_q)) {
          $feature_data .= "<span class='badge text-bg-light text-wrap'> $fea_row[name] </span>";
        }
        ...
        while ($fac_row = mysqli_fetch_assoc($fac_q)) {
          $facility_data .= "<span class='badge text-bg-light text-wrap'>$fac_row[name]</span>";
        }
  ...
  <div class="container mt-5">
    <div class="swiper swiper-testimonials">
      <div class="swiper-wrapper">
        ...
        <div class="col-lg-12 text-center mt-5">
          <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">Know More >>></a>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4">
        ...
        <div class="bg-white p-4 rounded mb-4">
          ...
          if ($contact_r['fb'] != '') {
            echo <<<data
                <a href="$contact_r[fb]" class="d-inline-block mb-3"><span class="badge bg-light text-dark fs-6 p-2"><i class="bi bi-facebook me-1"></i>Facebook</span></a><br />
              data;
          }
          ?>
          <?php
          if ($contact_r['insta'] != '') {
            echo <<<data
                <a href="$contact_r[insta]" class="d-inline-block mb-3"><span class="badge bg-light text-dark fs-6 p-2"><i class="bi bi-instagram me-1"></i>Instagram</span></a>
              data;
          }
          ?>
        </div>
...
<script>
  ...
  recovery_form.addEventListener("submit", (e) => {
    ...
    data.append('pass', recovery_form.elements['password'].value);
    ...
    xhr.onload = function() {
      if (this.responseText == 'failed') {
        alert_settings('error', 'Account reset failed');
      } else {
        alert_settings('success', 'Account Reset Successful!');
        recovery_form.reset();
