...
function add_image() {
  ...
  xhr.onload = function () {
    if (this.responseText == "inv_img") {
      ...
      alert_settings("error", "Image should be less than 2MB", "image-alert");
      ...
      alert_settings("success", "New Image Saved!", "image-alert");
...
function rem_image(img_id, room_id) {
  ...
  xhr.onload = function () {
    if (this.responseText == 1) {
      alert_settings("success", "Image Removed!", "image-alert");
      room_images(
        room_id,
        document.querySelector("#room-images .modal-title").innerText
      );
    } else {
      alert_settings("error", "Image Removed!", "image-alert");
    }
  };
...
function thumb_image(img_id, room_id) {
  ...
  xhr.onload = function () {
    if (this.responseText == 1) {
      alert_settings("success", "Image Thumbnail Changed!", "image-alert");
      room_images(
        room_id,
        document.querySelector("#room-images .modal-title").innerText
      );
    } else {
      alert_settings("error", "Thumbnail update failed!", "image-alert");
    }
  };
...
function submit_edit_room() {
  ...
  xhr.onload = function () {
    ...
    if (this.responseText == 1) {
      alert_settings("success", "Room data edited!");
...
function remove_room(room_id) {
  if (confirm("Are you sure, you want to delete this room?")) {
    ...
    xhr.onload = function () {
      if (this.responseText == 1) {
        alert_settings("success", "Room Removed!");
        get_all_rooms();
      } else {
        alert_settings("error", "Room Remove Failed!");
      }
    };
    xhr.send(data);
  }
