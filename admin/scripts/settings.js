...
function upd_general(site_title_val, site_about_val) {
  ...
  xhr.onload = function () {
    ...
    if (this.responseText == 1) {
      ...
      alert_settings("error", "No changes saved");
    }
  };
...
function upd_shutdown(val) {
  ...
  xhr.onload = function () {
    if (this.responseText == 1 && general_data.shutdown == 0) {
      alert_settings("success", "Site has been shutdown");
    } else {
      alert_settings("success", "Shutdown mode off");
    }
    get_general();
  };
...
function rem_member(val) {
  ...
  xhr.onload = function () {
    if (this.responseText == 1) {
      alert_settings("success", "Member removed!");
      get_members();
    } else {
